  ...
  return (
    <div className={styles.body}>
      <div className={styles.container}>
        ...
        <div
          className={`fas fa-quote-right fa-quote ${styles.rightIcon}`}
        ></div>
        <div className={`fas fa-quote-left fa-quote ${styles.leftIcon}`}></div>
        <p className={styles.testimonial}>{testimonials[currentIndex].text}</p>
